...
contract('SAETokenSale', function (accounts) {
	var tokenInstance;
	...
	it('initialize the contract with the correct values', function () {
		return SAETokenSale.deployed().then(function (instance) {
	...
	it('ends token sale', function () {
		return SAEToken.deployed().then(function (instance) {
			...
			assert.equal(balance.toNumber(), 999990, 'returns all unsold SAE tokens to admin');
